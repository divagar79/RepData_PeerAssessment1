...
```
* Mean = `r stepstakenbydayMean`
* Median =  `r stepstakenbydayMedian`
...
* Number of missing values = `r numbermissingvalues`
...
```
* Mean (Imputed) = `r totalstepsbydayImputed`
* Median (Imputed) =  `r totalstepsbydayImputedMedianImputed`
